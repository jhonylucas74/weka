...
import weka.classifiers.trees.randomForestSplitCriterionSelection.RandomTreeSplitCriterionSelection;
 ...
 */
public class RandomForestSplitCriterionSelection 
  ...
  /** It use the same split criteria as Random Tree 
   *  in order to avoid errors.
   */
  public static final Tag [] TAGS_SPLITCRIT = RandomTreeSplitCriterionSelection.TAGS_SPLITCRIT;
  
  /** It uses the same split criteria as 
   * Random tree. The default criterion 
   * is Mutual Information 
  */
  public static final int SPLITCRIT_DEFAULT = RandomTreeSplitCriterionSelection.SPLITCRIT_DEFAULT;
  public static final int SPLITCRIT_AMI = RandomTreeSplitCriterionSelection.SPLITCRIT_AMI;
  public static final int SPLITCRIT_GMI = RandomTreeSplitCriterionSelection.SPLITCRIT_GMI;
  ...
  public void buildClassifier(Instances data) throws Exception {
    ...
    RandomTreeSplitCriterionSelection rTree = new RandomTreeSplitCriterionSelection();

    // set up the random tree options
    m_KValue = m_numFeatures;
    if (m_KValue < 1) m_KValue = (int) Utils.log2(data.numAttributes())+1;
    rTree.setKValue(m_KValue);
    rTree.setSplitCrit(new SelectedTag(m_splitCrit, TAGS_SPLITCRIT));
  ...
  public String toString() {
    ...
    if (m_bagger == null) { 
      ...
      temp.append("Random forest of " + m_numTrees
          ...
          + "Splitting criterion: " +  getSplitCrit().getSelectedTag().getReadable() + "\n"          
          + "Out of bag error: "
  ...
  public static void main(String[] argv) {
    runClassifier(new RandomForestSplitCriterionSelection(), argv);
  }
}
